...
#     ]
#     resources = ["arn:aws:ecs:${var.region}:${local.account_id}:*"]
#   }
#
#   statement {
#     sid    = "AllowEC2andVPCPermissions"
#     effect = "Allow"
#     actions = [
#       "ec2:*"
#     ]
#     resources = ["arn:aws:ec2:${var.region}:${local.account_id}:*"]
#   }
#
#   statement {
#     sid    = "AllowALBAccess"
...
#     resources = ["arn:aws:elasticloadbalancing:${var.region}:${local.account_id}:*"]
#   }
#
#   statement {
...
#     resources = ["arn:aws:acm:${var.region}:${local.account_id}:*"]
#   }
#
#   statement {
